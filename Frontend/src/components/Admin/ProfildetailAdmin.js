...
const ProfiledetailAdmin =({phone,city}) =>  {
        ...
        return (
            ...
            <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                ...
                <i className="feather-map-pin text-grey-500 me-3 font-lg"></i>
                    <h4 className="fw-700 text-grey-900 font-xssss mt-0">{city} <span className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500"></span></h4>
                </div>
...
export default ProfiledetailAdmin;